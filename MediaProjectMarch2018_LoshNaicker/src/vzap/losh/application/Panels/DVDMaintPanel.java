...
public class DVDMaintPanel extends JPanel implements ActionListener, ChangeListener
{
	...
	public DVDMaintPanel (JPanel jFramePanelWayBack, User currentUser) {
		{	
			...
			this.add(largeLabel =new JLabel("DVD Maintenance Screen"),BorderLayout.NORTH);
			tabbedPane.addChangeListener(this);
			panelCheck = new DVDMaintPanelEditPane(this, currentUser);
			
			tabbedPane.add("Add  ", new DVDMaintPanelAddPane() );  
