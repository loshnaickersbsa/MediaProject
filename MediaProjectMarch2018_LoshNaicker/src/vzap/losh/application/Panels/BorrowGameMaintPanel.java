...
public class BorrowGameMaintPanel extends JPanel implements ActionListener, ChangeListener
{
	...
	private GAMEMaintPanelEditPane panelCheck;
	

	// The media Catalog needed 
	public BorrowGameMaintPanel (JPanel jFramePanelWayBack, User currentUser) {
		{	
			...
			this.add(largeLabel =new JLabel("Borrow GAME Screen"),BorderLayout.NORTH);
			tabbedPane.addChangeListener(this);
			panelCheck = new GAMEMaintPanelEditPane(this, currentUser);
			
			tabbedPane.add("Search  ", panelCheck);
			tabbedPane.add("Borrow  ", new BorrowMediaPanel(Media_Type.GAME, currentUser) );  
			tabbedPane.add("Borrowed list ", new BorrowedMediaPanelList(Media_Type.GAME, currentUser) );  
