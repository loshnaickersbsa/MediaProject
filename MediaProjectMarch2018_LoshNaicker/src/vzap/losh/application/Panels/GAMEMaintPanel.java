...
public class GAMEMaintPanel extends JPanel implements ActionListener, ChangeListener
{
	...
	public GAMEMaintPanel (JPanel jFramePanelWayBack, User currentUser) {
		{	
			...
			this.add(largeLabel =new JLabel("GAME Maintenance Screen"),BorderLayout.NORTH);
			tabbedPane.addChangeListener(this);
			panelCheck = new GAMEMaintPanelEditPane(this, currentUser);
			
			tabbedPane.add("Add  ", new GAMEMaintPanelAddPane() );  
