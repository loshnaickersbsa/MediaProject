...
//inherited by CD, DVD and GAME
 ...
 public Media(String mediaName, Media_Type mediaType, int duration, Genre genre, int copies)  throws MediaNameException 
 {
 ...
 public Media(String mediaName, Media_Type mediaType,  Genre genre, int copies)  throws MediaNameException
 {
   this(mediaName,mediaType,0,genre,copies);
 }
